 ...
 * @license MIT
 */
import { defineComponent, h, computed, openBlock, createElementBlock, normalizeClass, unref, createBlock, resolveDynamicComponent, createCommentVNode, renderSlot, createElementVNode } from 'vue';
...
var script$1 = /*#__PURE__*/ defineComponent({
    ...
    setup(__props) {
         ...
         * @return IconType
         */
        const iconCpd = computed(() => {
            return typeof icon === 'string' ? h(Icon, { src: icon, fill: 'currentColor' }, null) : icon;
        });
        //判断大小是不是Small或者Tiny
        ...
        return (_ctx, _cache) => {
            return (openBlock(), createElementBlock("button", {
                class: normalizeClass(unref(classStr)),
                disabled: unref(disabled)
            }, [
                (unref(hasLeftIcon))
                    ? (openBlock(), createBlock(resolveDynamicComponent(unref(iconCpd)), {
                        key: 0,
...
var avatar = defineComponent({
    ...
    setup(props, { slots }) {
        return () => {
            ...
            return (h("div", { class: mainCls.value },
                h("div", { class: classCls.value, style: style.value },
                    h("img", { src: src }))));
        };
    },
});
        ...
        return (_ctx, _cache) => {
            return (openBlock(), createElementBlock("div", {
                ...
                createElementVNode("div", _hoisted_1, [
                    createCommentVNode(" <svg xmlns=\"http://www.w3.org/2000/svg\" fill=\"none\" viewBox=\"0 0 24 24\" class=\"w-6 h-6 mx-2 stroke-current\">          \r\n      <path stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"2\" d=\"M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-6l-2-2H5a2 2 0 00-2 2z\"></path>                \r\n    </svg>  "),
                    (openBlock(), createBlock(resolveDynamicComponent(unref(iconCpd)), { class: "w-6 h-6 mx-2 stroke-current" })),
...
export { script as Alert, avatar as Avatar, script$1 as DButton, Icon };
